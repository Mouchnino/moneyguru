# Unit Name: moneyguru.gui.income_statement_test
# $Id$
...
from ..main_test import TestCase, CommonSetup, CallLogger
...
class MultipleCurrencies(TestCase):
    def setUp(self):
        ...
        self.add_account('CAD account', currency=CAD, account_type=INCOME, group_name='Group')
        self.add_entry('1/1/2008', 'USD entry', increase='100.00')
        self.add_account('USD account', currency=USD, account_type=INCOME, group_name='Group')
...
class MultipleCurrenciesOverTwoMonths(TestCase):
    def setUp(self):
        ...
        self.add_account('CAD account', currency=CAD, account_type=INCOME)
        self.add_entry('1/1/2008', 'CAD entry', increase='200.00')
        self.add_entry('1/2/2008', 'CAD entry', increase='190.00')
        self.add_account('USD account', currency=USD, account_type=EXPENSE)
