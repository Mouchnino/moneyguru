# Unit Name: moneyguru.gui.account_reassign_panel_test
# Created By: Virgil Dupras
# Created On: 2009-04-12
# $Id$
# Copyright 2009 Hardcoded Software (http://www.hardcoded.net)

from ..main_test import TestCase, _ThreeAccountsAndOneEntry

class DeletingSecondAccount(_ThreeAccountsAndOneEntry):
    def setUp(self):
        _ThreeAccountsAndOneEntry.setUp(self)
