# Unit Name: moneyguru.gui.income_statement
# $Id$
...
class IncomeStatement(Report):
    ...
    def _compute_account_node(self, node):
        ...
        budgeted = account.normal_budgeted_amount(date_range)
        budgeted_native = account.normal_budgeted_amount(date_range, currency)
        last_budgeted = account.normal_budgeted_amount(date_range.prev())
        last_budgeted_native = account.normal_budgeted_amount(date_range.prev(), currency)
