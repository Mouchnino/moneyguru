# Unit Name: moneyguru.gui.transaction_table_test
...
class ThreeTransactionsEverythingReconciled(TestCase):
    ...
    def test_cancel_change(self):
        """It's possible to cancel the txn change"""
    ...
    def test_change_txn_amount(self):
    ...
    def test_change_txn_date(self):
        """Changing the date of a transaction with reconciled splits unreconciles those splits as 
        well as the entries following each of those splits.
        """
        self.ttable[1].date = '18/07/2008'
        self.ttable.save_edits()
        self.document.select_balance_sheet()
    ...
    def test_change_txn_from(self):
        """Changing the from of a transaction with reconciled splits unreconciles only affected
        splits.
        """
        ...
        # Verify that the correct confirmation has taken place
        self.check_gui_calls(self.document_gui, confirm_unreconciliation=1)
        self.assertEqual(self.document_gui.last_affected_split_count, 1)
    
    def test_change_txn_to(self):
        """Changing the to of a transaction with reconciled splits unreconciles only affected
        splits.
        """
