...
class DocPropsView(BaseView):
    ...
    def __init__(self, view, mainwindow):
        ...
        def setfunc(index):
            self.app.year_start_month = index + 1
    ...
    def _revalidate(self):
        self.first_weekday_list.selected_index = self.app.first_weekday
        self.ahead_months_list.selected_index = self.app.ahead_months
        self.year_start_month_list.selected_index = self.app.year_start_month - 1
