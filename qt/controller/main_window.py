...
class MainWindow(QMainWindow):
    ...
    def _setupUi(self): # has to take place *before* base elements creation
        ...
        self.horizontalLayout_2 = QtGui.QHBoxLayout(self.topBar)
        ...
        self.horizontalLayout = QtGui.QHBoxLayout(self.bottomBar)
        self.horizontalLayout.setMargin(2)
        self.horizontalLayout.setMargin(0)
        self.newItemButton = QtGui.QPushButton(self.bottomBar)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(':/plus_8'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.newItemButton.setIcon(icon)
        self.horizontalLayout.addWidget(self.newItemButton)
        self.deleteItemButton = QtGui.QPushButton(self.bottomBar)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.deleteItemButton.sizePolicy().hasHeightForWidth())
        self.deleteItemButton.setSizePolicy(sizePolicy)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(':/minus_8'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.deleteItemButton.setIcon(icon1)
        self.horizontalLayout.addWidget(self.deleteItemButton)
        self.editItemButton = QtGui.QPushButton(self.bottomBar)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.editItemButton.sizePolicy().hasHeightForWidth())
        self.editItemButton.setSizePolicy(sizePolicy)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(':/info_gray_12'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionOpenDocument = QtGui.QAction(trui("Open..."), self)
        self.actionOpenDocument.setShortcut("Ctrl+O")
        self.actionShowNetWorth = QtGui.QAction(trui("Net Worth"), self)
        self.actionShowNetWorth.setShortcut("Ctrl+1")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(':/balance_sheet_48'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShowNetWorth.setIcon(icon3)
        self.actionShowProfitLoss = QtGui.QAction(trui("Profit & Loss"), self)
        self.actionShowProfitLoss.setShortcut("Ctrl+2")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(':/income_statement_48'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShowProfitLoss.setIcon(icon4)
        self.actionShowTransactions = QtGui.QAction(trui("Transactions"), self)
        self.actionShowTransactions.setShortcut("Ctrl+3")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(':/transaction_table_48'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShowTransactions.setIcon(icon5)
        self.actionShowSelectedAccount = QtGui.QAction(trui("Show Account"), self)
        self.actionShowSelectedAccount.setShortcut("Ctrl+]")
        self.actionNewItem = QtGui.QAction(trui("New Item"), self)
        self.actionNewItem.setShortcut("Ctrl+N")
        self.actionDeleteItem = QtGui.QAction(trui("Remove Selected"), self)
        self.actionEditItem = QtGui.QAction(trui("Show Info"), self)
        self.actionEditItem.setShortcut("Ctrl+I")
        self.actionMoveUp = QtGui.QAction(trui("Move Up"), self)
        self.actionMoveUp.setShortcut("Ctrl++")
        self.actionMoveDown = QtGui.QAction(trui("Move Down"), self)
        self.actionMoveDown.setShortcut("Ctrl+-")
        self.actionNavigateBack = QtGui.QAction(trui("Go Back"), self)
        self.actionNavigateBack.setShortcut("Ctrl+[")
        self.actionNewAccountGroup = QtGui.QAction(trui("New Account Group"), self)
        self.actionNewAccountGroup.setShortcut("Ctrl+Shift+N")
        self.actionShowNextView = QtGui.QAction(trui("Next View"), self)
        self.actionShowNextView.setShortcut("Ctrl+Shift+]")
        self.actionShowPreviousView = QtGui.QAction(trui("Previous View"), self)
        self.actionShowPreviousView.setShortcut("Ctrl+Shift+[")
        self.actionNewDocument = QtGui.QAction(trui("New Document"), self)
        self.actionOpenExampleDocument = QtGui.QAction(trui("Open Example Document"), self)
        self.actionImport = QtGui.QAction(trui("Import..."), self)
        self.actionImport.setShortcut("Ctrl+Alt+I")
        self.actionExport = QtGui.QAction(trui("Export..."), self)
        self.actionExport.setShortcut("Ctrl+Alt+E")
        self.actionSave = QtGui.QAction(trui("Save"), self)
        self.actionSave.setShortcut("Ctrl+S")
        self.actionSaveAs = QtGui.QAction(trui("Save As..."), self)
        self.actionSaveAs.setShortcut("Ctrl+Shift+S")
        self.actionRegister = QtGui.QAction(trui("Register moneyGuru"), self)
        self.actionAbout = QtGui.QAction(trui("About moneyGuru"), self)
        self.actionToggleReconciliationMode = QtGui.QAction(trui("Toggle Reconciliation Mode"), self)
        self.actionToggleReconciliationMode.setShortcut("Ctrl+Shift+R")
        self.actionToggleAccountExclusion = QtGui.QAction(trui("Toggle Exclusion Status of Account"), self)
        self.actionToggleAccountExclusion.setShortcut("Ctrl+Shift+X")
        self.actionShowSchedules = QtGui.QAction(trui("Schedules"), self)
        self.actionShowSchedules.setShortcut("Ctrl+4")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(':/schedules_48'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShowSchedules.setIcon(icon6)
        self.actionShowBudgets = QtGui.QAction(trui("Budgets"), self)
        self.actionShowBudgets.setShortcut("Ctrl+5")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(':/budget_48'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionShowBudgets.setIcon(icon7)
        self.actionShowViewOptions = QtGui.QAction(trui("View Options..."), self)
        self.actionShowViewOptions.setShortcut("Ctrl+J")
        self.actionReconcileSelected = QtGui.QAction(trui("Reconcile Selection"), self)
        self.actionReconcileSelected.setShortcut("Ctrl+R")
        self.actionMakeScheduleFromSelected = QtGui.QAction(trui("Make Schedule from Selected"), self)
        self.actionMakeScheduleFromSelected.setShortcut("Ctrl+M")
        self.actionShowPreferences = QtGui.QAction(trui("Preferences..."), self)
        self.actionPrint = QtGui.QAction(trui("Print..."), self)
        self.actionPrint.setShortcut("Ctrl+P")
        self.actionQuit = QtGui.QAction(trui("Quit moneyGuru"), self)
        self.actionQuit.setShortcut("Ctrl+Q")
        self.actionUndo = QtGui.QAction(trui("Undo"), self)
        self.actionUndo.setShortcut("Ctrl+Z")
        self.actionRedo = QtGui.QAction(trui("Redo"), self)
        self.actionRedo.setShortcut("Ctrl+Y")
        self.actionShowHelp = QtGui.QAction(trui("moneyGuru Help"), self)
        self.actionShowHelp.setShortcut("F1")
        self.actionCheckForUpdate = QtGui.QAction(trui("Check for update"), self)
        self.actionOpenDebugLog = QtGui.QAction(trui("Open Debug Log"), self)
        self.actionDuplicateTransaction = QtGui.QAction(trui("Duplicate Transaction"), self)
        self.actionDuplicateTransaction.setShortcut("Ctrl+D")
        self.actionJumpToAccount = QtGui.QAction(trui("Jump to Account..."), self)
        self.actionJumpToAccount.setShortcut("Ctrl+Shift+A")
        self.actionNewTab = QtGui.QAction(trui("New Tab"), self)
        self.actionNewTab.setShortcut("Ctrl+T")
        self.actionCloseTab = QtGui.QAction(trui("Close Tab"), self)
